...
public class ManagementHandler extends SimpleChannelUpstreamHandler {
	...
	public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) {
		...
		ManagementQueue.enqueueRequest((eye.Comm.Management) e.getMessage(),    // We can check message type here for other than HB/Network like leader election 
				e.getChannel(), e.getRemoteAddress());							// we can decide to use handle message according to type of the message
